...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/SimpleService.proto")
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cn.peng.studygodpath.frame.grpc.first.api.HelloRequest,
      cn.peng.studygodpath.frame.grpc.first.api.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = cn.peng.studygodpath.frame.grpc.first.api.HelloRequest.class,
      responseType = cn.peng.studygodpath.frame.grpc.first.api.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cn.peng.studygodpath.frame.grpc.first.api.HelloRequest,
      cn.peng.studygodpath.frame.grpc.first.api.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<cn.peng.studygodpath.frame.grpc.first.api.HelloRequest, cn.peng.studygodpath.frame.grpc.first.api.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<cn.peng.studygodpath.frame.grpc.first.api.HelloRequest, cn.peng.studygodpath.frame.grpc.first.api.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.peng.studygodpath.frame.grpc.first.api.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.peng.studygodpath.frame.grpc.first.api.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(cn.peng.studygodpath.frame.grpc.first.api.HelloRequest request,
        io.grpc.stub.StreamObserver<cn.peng.studygodpath.frame.grpc.first.api.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cn.peng.studygodpath.frame.grpc.first.api.HelloRequest,
                cn.peng.studygodpath.frame.grpc.first.api.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public cn.peng.studygodpath.frame.grpc.first.api.HelloReply sayHello(cn.peng.studygodpath.frame.grpc.first.api.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cn.peng.studygodpath.frame.grpc.first.api.HelloReply> sayHello(
        cn.peng.studygodpath.frame.grpc.first.api.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((cn.peng.studygodpath.frame.grpc.first.api.HelloRequest) request,
              (io.grpc.stub.StreamObserver<cn.peng.studygodpath.frame.grpc.first.api.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.peng.studygodpath.frame.grpc.first.api.HelloWorldProto.getDescriptor();
    }
