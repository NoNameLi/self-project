...
public class FileUtil {
	 ...
	 * @throws IOException
	 */
	public static final void addpendUsingOutputStream(String fileName, String data) throws IOException {
		//true: 表示是追加的标志
	 ...
	 * @throws IOException
	 */
	public static final void appendUsingBufferedWrite(String fileName, String data, int noOfLines) throws IOException {
		File file = new File(fileName);
		FileWriter fw = null;
	 ...
	 * @throws IOException
	 */
	public static final void appendUsingFileWrite(String fileName, String data) throws IOException {
		File file = new File(fileName);
		FileWriter fw = null;
		//true:表示是追加的标志
		fw = new FileWriter(file, true);
    ...
    public static List<String> findAllFileName(String url, final String suffix){
		...
		File[] list = FileUtil.listAll(file,filter);
